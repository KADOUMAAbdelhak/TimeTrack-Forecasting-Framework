...
| `robustness_statistics` (freeze-v1) | **REJECTED provisional** → `results/development/provisional_robustness_analysis/final-robustness-analysis-freeze-v1/robustness_statistics/` (tag force-updated) |
| `robustness_statistics` (freeze-v2) | COMPLETE (final-robustness-analysis-freeze-v2; immutable) |
